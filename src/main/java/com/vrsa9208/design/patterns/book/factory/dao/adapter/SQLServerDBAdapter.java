...
public class SQLServerDBAdapter implements IDBAdapter {
	...
	private static final Logger LOGGER = LogManager.getLogger(SQLServerDBAdapter.class);
	
	private static final String DB_PROPERTIES = "factory/DBSQLServer.properties";
