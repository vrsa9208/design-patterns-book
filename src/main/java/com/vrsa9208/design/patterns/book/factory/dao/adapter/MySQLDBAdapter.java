...
public class MySQLDBAdapter implements IDBAdapter {
	...
	private static final Logger LOGGER = LogManager.getLogger(MySQLDBAdapter.class);
	
	private static final String DB_PROPERTIES = "factory/DBMySQL.properties";
	...
	private String createConnectionString(Properties properties) {
		...
		return String.format(
				"jdbc:mysql://%s:%s/%s?useUnicode=true&useJDBCCompliantTimezoneShift=true&useLegacyDatetimeCode=false&serverTimezone=UTC&useSSL=false"
				, host, port, dbName);
	}
